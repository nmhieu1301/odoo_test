        ...
        container.each(function (i) {
            if (settings.typo) {
                ...
                jQuery(this).find("img").each(function (z) {
                    ...
                    //jQuery(this).after("<span class='typo' style='position: absolute; width:328px; margin: 0 0 0 -" + pictWidth + "px'>" + _count + "/" + jQuery(this).attr("alt") + "<\/span>");
                    //jQuery(this).after("<span class='typo' style='position: absolute; width:18px; margin:1px 0px 0px -30px;cursor:pointer;' onclick='visiable_tdImage();'title='Hide Images' >>><\/span>");
                    jQuery(this).after("<span class='typo' style='position: absolute; width:498px;cursor:pointer; margin: 0 0 0 -" + pictWidth + "px'  onclick='visiable_tdImage();'title='Hide Images' >>><\/span>");
                    jQuery(this).after("<span class='typo' style='position: absolute; width:40px; margin:1px 0px 0px -40px;' >" + _count + "/" + jQuery(this).attr("alt") + "<\/span>");
                    _count++;
                });
            }
            ...
            jQuery(this).find("li").each(function (n) {
                ...
                jQuery("div#thumbSlider" + j + " ul").append("<li><a href='#'><img width='" + thumbsWidth + "' height='" + thumbsHeight + "' src='" + jQuery(this).find("img").attr("src") + "' /><p class='tmbrdr'>&nbsp;<\/p><\/a><\/li>");
            });
            ...
            if (settings.typo) {
                jQuery(this).find("span.typo").each(function (z) {
                    ...
                    jQuery(this).css({ marginTop: 0, opacity: settings.typoFullOpacity });
                });
            }
            ...
            jQuery("a#left" + j).css({ display: "block", textAlign: "center", width: "19px", height: thumbsHeight + "px", margin: -(thumbsHeight - settings.thumbsTopMargin) + "px 0 0 " + lbttLeftMargin + "px", textDecoration: "none", lineHeight: thumbsHeight + "px", color: settings.buttonsTextColor });
            jQuery("a#right" + j).css({ display: "block", textAlign: "center", width: "19px", height: thumbsHeight + "px", margin: -(thumbsHeight) + "px 0 0 " + rbttLeftMargin + "px", textDecoration: "none", lineHeight: thumbsHeight + "px", color: settings.buttonsTextColor });
